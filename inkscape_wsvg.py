...
from svgwrite_inkscape_drawing import InkscapeDrawing
from time import time
from warnings import warn

# Internal dependencies
from svgpathtools import Path, Line, is_path_segment
from svgpathtools.misctools import open_in_browser
...
def disvg(paths=None, colors=None,
    ...
    if svg_attributes:
        ...
        dwg = InkscapeDrawing(filename=filename, size=(szx, szy), viewBox=viewbox)
