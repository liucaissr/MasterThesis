...
p3 = Path(MicroLine(Coordinate(1 + 0j), Coordinate(2 + 0j)),
          MicroLine(Coordinate(2 + 0j), Coordinate(2 + 0.5j)),
          MicroLine(Coordinate(2 + 0.5j), Coordinate(1 + 0.5j)),
          MicroLine(Coordinate(1 + 0.5j), Coordinate(1 + 0j)))

l1 = MicroLine(Coordinate(1, 1), Coordinate(1, 0))
l2 = MicroLine(Coordinate(2, 1), Coordinate(1, 1))

p1 = Path(MicroLine(Coordinate(0, 8.277), Coordinate(31.607, 8.277)),
          MicroLine(Coordinate(31.607, 8.277), Coordinate(31.607, 10.063)),
          MicroLine(Coordinate(31.607, 10.063), Coordinate(0, 10.063)),
          MicroLine(Coordinate(0, 10.063), Coordinate(0, 8.277)))

p2 = Path(MicroLine(Coordinate(30.756, 10.063), Coordinate(31.607, 10.063)),
          MicroLine(Coordinate(31.607, 10.063), Coordinate(31.607, 35.83)),
          MicroLine(Coordinate(31.607, 35.83), Coordinate(30.756, 35.83)),
          MicroLine(Coordinate(30.756, 35.83), Coordinate(30.756, 10.063)))

p1 = Path(MicroLine(Coordinate(0, 0), Coordinate(1, 0)),
          MicroLine(Coordinate(1, 0), Coordinate(1, 1)),
          MicroLine(Coordinate(1, 1), Coordinate(0, 1)),
          MicroLine(Coordinate(0, 1), Coordinate(0, 0)))

p2 = Path(MicroLine(Coordinate(0, 0.8), Coordinate(2, 0.8)),
          MicroLine(Coordinate(2, 0.8), Coordinate(2, 1)),
          MicroLine(Coordinate(2, 1), Coordinate(0, 1)),
          MicroLine(Coordinate(0, 1), Coordinate(0, 0.8))
          ,)

p3 = Path(MicroLine(Coordinate(0.2, 2), Coordinate(3, 2)),
          MicroLine(Coordinate(3, 2), Coordinate(3, 3)),
          MicroLine(Coordinate(3, 3), Coordinate(0.2, 3)),
          MicroLine(Coordinate(0.2, 3), Coordinate(0.2, 2)))

l1 = MicroLine(Coordinate(0, 0), Coordinate(0.5, 0))
l2 = p2[0]


rawpaths, attributes = svg2paths('/Users/my/Desktop/MasterThesis/mt1git/ImageToTextDescriptor/resultsvg/171130-MicroHeaterLayout-final/171130-MicroHeaterLayout-final.svg')

#print two_paths_distance(rawpaths[1],rawpaths[16])
...
p1 = Path(MicroLine(Coordinate(0.25, 11681.551), Coordinate(999.75, 11681.551)),
          MicroLine(Coordinate(999.75, 11681.551), Coordinate(999.75, 12681.151)),
          MicroLine(Coordinate(999.75, 12681.151), Coordinate(0.25, 12681.151)),
          MicroLine(Coordinate(0.25, 12681.151), Coordinate(0.25, 11681.551)))

p2 = Path(MicroLine(Coordinate(250.25, 12681.151), Coordinate(749.75, 12681.151)),
          MicroLine(Coordinate(749.75, 12681.151), Coordinate(749.75, 15681.151)),
          MicroLine(Coordinate(749.75, 15681.151), Coordinate(250.25, 15681.151)),
          MicroLine(Coordinate(250.25, 15681.151), Coordinate(250.25, 12681.151)))

p1 = Path(MicroLine(Coordinate(1936.558, 13122.943), Coordinate(2086.557, 13122.943)),
          MicroLine(Coordinate(2086.557, 13122.943), Coordinate(2086.557, 13197.443)),
          MicroLine(Coordinate(2086.557, 13197.443), Coordinate(1936.558, 13197.443)),
          MicroLine(Coordinate(1936.558, 13197.443), Coordinate(1936.558, 13122.943)))

p2 = Path(MicroLine(Coordinate(2086.557, 13122.943), Coordinate(2161.058, 13122.943)),
          MicroLine(Coordinate(2161.058, 13122.943), Coordinate(2161.058, 16180.652)),
          MicroLine(Coordinate(2161.058, 16180.652), Coordinate(2086.557, 16180.652)),
          MicroLine(Coordinate(2086.557, 16180.652), Coordinate(2086.557, 13122.943)))

p3 = Path(MicroLine(Coordinate(1936.558, 13197.443), Coordinate(2011.058, 13197.443)),
          MicroLine(Coordinate(2011.058, 13197.443), Coordinate(2011.058, 16106.152)),
          MicroLine(Coordinate(2011.058, 16106.152), Coordinate(1936.558, 16106.152)),
          MicroLine(Coordinate(1936.558, 16106.152), Coordinate(1936.558, 13197.443)))

# print two_paths_intersection(p[1], p[2])
